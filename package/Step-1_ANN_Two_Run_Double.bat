...
SET "today=%date:~0,10%"
start %project_root%\package\Step-1_ANN_Two_Run_ProcessA.bat   :: start will create new process for this bat
...
start %project_root%\package\Step-1_ANN_Two_Run_ProcessB.bat
