...
for year in range(2021,2022):
    ...
    for month in range(7,13):
        ...
        while date <= endDate:
            ...
            #     存檔
            # =============================================================================
            # with open('newfolder/newtxt.txt',mode= 'w',encoding='utf-8') as file :
            #     file.write('hahahahahahahahah')
        ...
        path = r'C:/Users/Vivian/Desktop/資訊碩士/資訊碩二上/畢業論文研究/StockPrediction/data/News/{}'.format(symbol_id)
        if not os.path.exists(path):
            os.makedirs(path)
        df_all.to_csv(path+r'/news_{}_{}.csv'.format(symbol_id,startDateStr[:6]),encoding='utf_8_sig',index=False)
        df_all[df_all['timestamp'].str.contains(lastDate)].to_csv('XD.csv',encoding='utf_8_sig',index=False)
