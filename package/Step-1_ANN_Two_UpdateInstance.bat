...
xcopy  %project_root%\data\Step-0_ANN_Two_Result_ProcessC.csv  %instance_root%\data\Step-0_ANN_Two_Result_ProcessC.csv  /Y
xcopy  %project_root%\data\Step-0_ANN_Two_Result_ProcessD.csv  %instance_root%\data\Step-0_ANN_Two_Result_ProcessD.csv  /Y
xcopy  %project_root%\data\Step-0_ANN_Two_Result_ProcessE.csv  %instance_root%\data\Step-0_ANN_Two_Result_ProcessE.csv  /Y
...
xcopy  %project_root%\package\Step-1_ANN_Two_Run_Double.bat  %instance_root%\package\Step-1_ANN_Two_Run_Double.bat  /Y
xcopy  %project_root%\package\Step-1_ANN_Two_Run_Triple.bat  %instance_root%\package\Step-1_ANN_Two_Run_Triple.bat  /Y
...
xcopy  %project_root%\package\Step-1_ANN_Two_Run_ProcessC.bat  %instance_root%\package\Step-1_ANN_Two_Run_ProcessC.bat  /Y
xcopy  %project_root%\package\Step-1_ANN_Two_Run_ProcessD.bat  %instance_root%\package\Step-1_ANN_Two_Run_ProcessD.bat  /Y
xcopy  %project_root%\package\Step-1_ANN_Two_Run_ProcessE.bat  %instance_root%\package\Step-1_ANN_Two_Run_ProcessE.bat  /Y
...
xcopy  %project_root%\package\Step-1_ANN_Two_SchtaskDelete.bat  %instance_root%\package\Step-1_ANN_Two_SchtaskDelete.bat  /Y
xcopy  %project_root%\package\Step-1_NewEnvBuild.py  %instance_root%\package\Step-1_NewEnvBuild.py  /Y
xcopy  %project_root%\package\Step-1_NewEnvBuild_Run.bat  %instance_root%\package\Step-1_NewEnvBuild_Run.bat  /Y
