schtasks /create  /sc minute  /mo 30 /sd 2022/06/17 /st 22:00 /ed 2022/08/10 /tn ANN_Two /tr  D:\StockPrediction\StockPrediction\package\Step_1_ANN_Two_CombineCSV_Run.bat
